...
* Automatically compensates for reverse-direction values: When min > max, value is assumed to travel
in reverse direction.
* If zeroToOneOnly is true, then % will be capped at 0%-100% (no negative % or > 100%)
* If range == 0, then 0 will be returned.  (Safety: in case of problem during regen torque
calculation)
-------------------------------------------------------------------*/
...
/**********************************************************************/ /**
                                                                          ...
                                                                          *
                                                                          * \param timestamp     A
                                                                          *timestamp from IO_RTC for
                                                                          *when the blink was
                                                                          *started \param highPeriod
                                                                          *How long the blink should
                                                                          *stay high, in ms (NOT ns)
                                                                          * \param lowPeriod     How
                                                                          *long the blink should
                                                                          *stay low -- NOT
                                                                          *IMPLEMENTED; Always the
                                                                          *same as highPeriod
                                                                          *
                                                                          * \return boolean:
                                                                          * \retval TRUE      blink
                                                                          *should be high \retval
                                                                          *FALSE     blink should be
                                                                          *low
                                                                          *
                                                                          ***************************************************************************
                                                                          *
