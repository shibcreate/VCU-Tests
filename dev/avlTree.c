...
*/
// AVLNode* AVL_insert(AVLNode* t, ubyte4 messageID, ubyte1 messageData[8], ubyte4 minTime, ubyte4
// maxTime, bool req)
AVLNode *AVL_insert(AVLNode **messageHistoryArray, ubyte4 messageID, ubyte1 messageData[8],
                    ubyte4 minTime, ubyte4 maxTime, bool req)
{
    ...
    else
    {
        ...
        // http://stackoverflow.com/questions/9262784/array-equal-another-array
