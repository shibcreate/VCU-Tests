...
struct _BatteryManagementSystem
{
    ...
    ubyte4 cellShuntingStatusArray1_0; // 7:4, , bit0=1 - shunting active for cell 1 | bit31=1 -
                                       // shunting active for cell 32
    ubyte4 cellShuntingStatusArray1_1; // 3:0, , bit0=1 - shunting active for cell 33 | bit31=1 -
                                       // shunting active for cell 64

    // BMS_CELL_SHUNTING_STATUS_2 //
    ubyte4 cellShuntingStatusArray2_0; // 7:4, , bit0=1 - shunting active for cell 65 | bit31=1 -
                                       // shunting active for cell 96
    ubyte4 cellShuntingStatusArray2_1; // 3:0, , bit0=1 - shunting active for cell 97 | bit31=1 -
                                       // shunting active for cell 128

    // BMS_CELL_SHUNTING_STATUS_3 //
    ubyte4 cellShuntingStatusArray3_0; // 7:4, , bit0=1 - shunting active for cell 129 | bit31=1 -
                                       // shunting active for cell 160
    ubyte4 cellShuntingStatusArray3_1; // 3:0, , bit0=1 - shunting active for cell 161 | bit31=1 -
                                       // shunting active for cell 192

    // BMS_CELL_SHUNTING_STATUS_4 //
    ubyte4 cellShuntingStatusArray4_0; // 7:4, , bit0=1 - shunting active for cell 193 | bit31=1 -
                                       // shunting active for cell 224
    ubyte4 cellShuntingStatusArray4_1; // 3:0, , bit0=1 - shunting active for cell 225 | bit31=1 -
                                       // shunting active for cell 256
...
{
    BatteryManagementSystem *me =
        (BatteryManagementSystem *) malloc(sizeof(struct _BatteryManagementSystem));
...
void BMS_parseCanMessage(BatteryManagementSystem *bms, IO_CAN_DATA_FRAME *bmsCanMessage)
{
    ...
    case BMS_PACK_SAFE_OPERATING_ENVELOPE:
        bms->chargerConstVoltageSetPoint =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->maxDischargeCurrentAllowed =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->maxChargeCurrentAllowed =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;

    case BMS_MASTER_LOCAL_BOARD_MEASUREMENTS:
        bms->boardTemperature =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->powerInputSense_12V_24V =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->powerInputSense_HVIL =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->internalRailSense_5V =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;
    ...
    case BMS_PACK_LEVEL_MEASUREMENTS_2:
        bms->packStateOfCharge =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->packStateOfHealth =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->packAmpHoursRemaining =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
    ...
    case BMS_CELL_VOLTAGE_SUMMARY:
        bms->highestCellVoltage =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->lowestCellVoltage =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->highestCellVoltagePos =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->lowestCellVoltagePos =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;

    case BMS_CELL_TEMPERATURE_SUMMARY:
        bms->highestCellTemperature =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->lowestCellTemperature =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->highestCellTemperaturePos =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->lowestCellTemperaturePos =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;

    case BMS_PACK_LEVEL_MEASUREMENTS_3:
        bms->sumOfCellVoltages =
            (((ubyte4) bmsCanMessage->data[7] << 24) | ((ubyte4) bmsCanMessage->data[6] << 16) |
             ((ubyte4) bmsCanMessage->data[5] << 8) | ((ubyte4) bmsCanMessage->data[4]));
        bms->preChargeVoltage =
            (((ubyte4) bmsCanMessage->data[3] << 24) | ((ubyte4) bmsCanMessage->data[2] << 16) |
             ((ubyte4) bmsCanMessage->data[1] << 8) | ((ubyte4) bmsCanMessage->data[0]));
        break;

    case BMS_CELL_VOLTAGE_DATA:
        bms->cellVoltage_4X_1 =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->cellVoltage_4X_2 =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->cellVoltage_4X_3 =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->cellVoltage_4X_4 =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;

    case BMS_CELL_TEMPERATURE_DATA:
        bms->cellTemperature_4X_1 =
            (((ubyte2) bmsCanMessage->data[7] << 8) | ((ubyte2) bmsCanMessage->data[6]));
        bms->cellTemperature_4X_2 =
            (((ubyte2) bmsCanMessage->data[5] << 8) | ((ubyte2) bmsCanMessage->data[4]));
        bms->cellTemperature_4X_3 =
            (((ubyte2) bmsCanMessage->data[3] << 8) | ((ubyte2) bmsCanMessage->data[2]));
        bms->cellTemperature_4X_4 =
            (((ubyte2) bmsCanMessage->data[1] << 8) | ((ubyte2) bmsCanMessage->data[0]));
        break;
...
// ***NOTE: packCurrent and and packVoltage are SIGNED variables and the return type for
// BMS_getPower is signed
