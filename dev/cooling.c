...
void CoolingSystem_calculationsPump(CoolingSystem *me, sbyte2 motorControllerTemp, sbyte2 motorTemp,
                                    sbyte1 batteryTemp, Sensor *HVILTermSense)
{
    ...
    else if (HVILTermSense->sensorValue == FALSE &&
             (motorControllerTemp >= 50.0 || motorTemp >= 50.0))
    {
        me->waterPumpPercent = 1;
    }
    else
...
void CoolingSystem_calculationsFans(CoolingSystem *me, sbyte2 motorControllerTemp, sbyte2 motorTemp,
                                    sbyte1 batteryTemp, Sensor *HVILTermSense)
{
    ...
    {
        // me->radFanPercent = .2 + .7 * getPercent(max(motorControllerTemp, motorTemp),
        // me->radFanLow, me->radFanHigh, TRUE);
