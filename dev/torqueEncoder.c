...
TorqueEncoder *TorqueEncoder_new(bool benchMode)
{
    ...
    // exponent applied to pedal curve.  1 = linear, < 1 means more torque is given early on, > 1
    // means torque ramps up more slowly
...
void TorqueEncoder_update(TorqueEncoder *me)
{
    ...
    else
    {
        ...
        else
        {
            ...
            me->tps0_percent =
                getPercent(me->tps0_value, me->tps0_calibMin, me->tps0_calibMax, TRUE);
            me->tps1_percent =
                getPercent(me->tps1_value, me->tps1_calibMin, me->tps1_calibMax, TRUE);
...
void TorqueEncoder_getIndividualSensorPercent(TorqueEncoder *me, ubyte1 sensorNumber,
                                              float4 *percent)
{
    switch (sensorNumber)
    {
