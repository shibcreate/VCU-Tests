...
void IC_parseCanMessage(InstrumentCluster *me, MotorController *mcm,
                        IO_CAN_DATA_FRAME *icCanMessage)
{
    ...
    case 0x703:
    {
        ...
        // MCM_setRegen_TorqueLimitDNm(mcm, (ubyte2)icCanMessage->data[1] << 8 |
        // icCanMessage->data[0]); MCM_setRegen_TorqueAtZeroPedalDNm(mcm,
        // (ubyte2)icCanMessage->data[3] << 8 | icCanMessage->data[2]);
        break;
    }
    ...
    case 0x704:
    {
        ...
        * (ubyte4 *) &BPSfloat = (ubyte4)icCanMessage->data[3] << 24 | (ubyte4)icCanMessage->data[2]
        << 16 | icCanMessage->data[1] << 8 | icCanMessage->data[0];
        * (ubyte4 *) &APPSfloat = (ubyte4)icCanMessage->data[7] << 24 |
        (ubyte4)icCanMessage->data[6] << 16 | icCanMessage->data[5] << 8 | icCanMessage->data[4];
